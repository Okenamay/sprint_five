...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	SpeedInMS := w.meanSpeed() * 1000 / 3600
	return ((CaloriesWeightMultiplier*w.Training.Weight + (math.Pow(SpeedInMS, 2)/w.Height)*CaloriesSpeedHeightMultiplier*w.Training.Weight) * w.Duration.Hours() * MinInHours)
}
...
func ReadData(training CaloriesCalculator) string {
	...
	return fmt.Sprint(calories, info)
}
